...
mqttc.message_callback_add("$SYS/broker/messages/sach", on_message_msgs)
mqttc.message_callback_add("$SYS/broker/bytes/sach", on_message_bytes)
mqttc.on_message = on_message
mqttc.connect("broker.mqttdashboard.com", 8000, 60)
mqttc.subscribe("$SSB/sach", 0)
